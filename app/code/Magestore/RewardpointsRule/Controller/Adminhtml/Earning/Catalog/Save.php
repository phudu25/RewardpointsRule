 ...
 */
class Save extends \Magestore\RewardpointsRule\Controller\Adminhtml\Earning\Catalog
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPostValue()){
            $model = $this->_earningCatalogFactory->create()->load($this->getRequest()->getParam('id'));
