 ...
 */
class Edit extends \Magestore\RewardpointsRule\Controller\Adminhtml\Earning\Catalog
{
    /**
    ...
    public function execute()
    {
        ...
        $model  = $this->_earningCatalogFactory->create()->load($id);
        ...
        if ($model->getId() || $id == 0) {
            ...
            if ($model->getId()){
                ...
                $resultPage->getConfig()->getTitle()->prepend(__('New Catalog Earning Rule'));
            }
        } else {
