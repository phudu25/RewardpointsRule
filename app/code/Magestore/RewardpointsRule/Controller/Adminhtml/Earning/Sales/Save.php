 ...
 */
class Save extends \Magestore\RewardpointsRule\Controller\Adminhtml\Earning\Sales
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPostValue()){
            $model = $this->_earningSalesFactory->create()->load($this->getRequest()->getParam('id'));
