...
class Individual extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Magestore_RewardpointsRule::Spending_Individual');
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Magestore_RewardpointsRule::Spending_Individual');
    }
}
