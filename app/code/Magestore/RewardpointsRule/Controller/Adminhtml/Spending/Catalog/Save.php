 ...
 */
class Save extends \Magestore\RewardpointsRule\Controller\Adminhtml\Spending\Catalog
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPostValue()){
            $model = $this->_spendingCatalogFactory->create()->load($this->getRequest()->getParam('id'));
