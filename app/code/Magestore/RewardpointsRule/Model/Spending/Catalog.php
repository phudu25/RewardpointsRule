<?php
namespace Magestore\RewardpointsRule\Model\Spending;

/**
 * Class Catalog
 * @package Magestore\RewardpointsRule\Model\Spending
 */
class Catalog  extends \Magento\Rule\Model\AbstractModel
{

    const LIMIT_NONE = 'none';
    const LIMIT_BY_PRICE = 'by_price';
    const LIMIT_BY_PERCENT = 'by_percent';
    /**
    ...
    {
        $this->_init('Magestore\RewardpointsRule\Model\ResourceModel\Spending\Catalog');
    }
